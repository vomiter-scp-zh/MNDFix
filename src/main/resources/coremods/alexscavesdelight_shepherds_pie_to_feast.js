...
var TARGET_CLASS = "net.fixerlink.alexscavesdelight.block.ModBlocks";

var OLD_OWNER = "vectorwing/farmersdelight/common/block/ShepherdsPieBlock";
...
function initializeCoreMod() {
    return {
        "alexscavesdelight_shepherds_pie_to_feast": {
            "target": {
                "type": "CLASS",
                "name": TARGET_CLASS
            },
            "transformer": function(classNode) {
                ...
                for (var i = 0; i < classNode.methods.size(); i++) {
                    ...
                    for (var instruction = instructions.getFirst(); instruction != null; instruction = instruction.getNext()) {
                        // Replace: NEW vectorwing/farmersdelight/common/block/ShepherdsPieBlock
                        ...
                        // Replace:
                        // INVOKESPECIAL vectorwing/farmersdelight/common/block/ShepherdsPieBlock.<init>(Properties, Supplier, boolean)V
                ...
                ASMAPI.log(
                    ...
                    " ShepherdsPieBlock constructor references to FeastBlock in " +
                    TARGET_CLASS
                );
